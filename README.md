...
| **C2.2.3** Sécurité & accessibilité                 | OWASP Top 10, OPQUAST, audits Lighthouse        | [01-architecture.md § Sécurité](./docs/01-architecture.md#6-sécurité--couverture-owasp-top-10), rapports [avant](lighthouse/1-avant-correctifs.report.html) / [après](lighthouse/2-apres-correctifs.report.html) correctifs |
